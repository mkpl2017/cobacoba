        ...
        <section class="global-page-header">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="block">
                            <h2>Artikel Kebudayaan dan Sejarah</h2>
                            <ol class="breadcrumb">
                                <li>
                                    <a href="<?php echo base_url();?>">
                                ...
                                <li class="active">Artikel Kebudayaan dan Sejarah</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-12">
                            <article class="wow fadeInDown" data-wow-delay=".3s" data-wow-duration="500ms">
                                <div class="blog-content">
                                    ...
                                    <a href="<?php echo base_url();?>artikelkebsej/readartikelkebsej/<?php echo $row->idArtikelKS; ?>"><?php echo $row->judul; ?></a>
                                    </h2>
                                         <?php echo $row->ringkasan; ?>
                                    <a href="<?php echo base_url();?>artikelkebsej/readartikelkebsej/<?php echo $row->idArtikelKS; ?>" class="btn btn-dafault btn-details">Read More</a>
                                     <hr size="16px" width="100%" align="right">
                                    <?php endforeach; ?>

            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <div class="navbar-brand">
                        <a href="<?php echo base_url();?>admin/authentifikasi">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form name="form1" method="post" action="<?php echo base_url(); ?>artikelkebsej/tambahartikelkebsej" class="myform">
                                <p><label for="idUser">id User</label>
                                    <input name="idUser" type="text" id="idUser" size="70">
                                </p>

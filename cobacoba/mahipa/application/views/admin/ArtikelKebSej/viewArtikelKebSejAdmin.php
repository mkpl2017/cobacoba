         ...
         <section class="single-post">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div align="right">
                                <a href="<?php echo base_url() ?>artikelkebsej/tambahartikelkebsej" class="tambah">Tambah Artikel</a>
                            </div>
                            

                            <p>ARTIKEL KEBUDAYAAN DAN SEJARAH</p>
                            <table  id="table" class="table table-hover table-mc-light-blue">
                                ...
                                <tr>
                                    <td>
                                        <a href="<?php echo base_url() ?>artikelkebsej/readartikelkebsej/<?php echo $row->idArtikelKS ?>" target="_blank">

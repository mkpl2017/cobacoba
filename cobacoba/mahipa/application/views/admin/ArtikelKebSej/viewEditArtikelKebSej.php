                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form name="form1" method="post" action="<?php echo base_url(); ?>artikelkebsej/editartikelkebsej" class="myform">
                                <p><label for="judul">ID User</label>
                                    <input name="idUser" type="type" id="idUser" size="70" value="<?php echo $detail['idUser'] ?>">
                                </p>
                                ...
                                <p>
                                    <input name="idArtikelKS" type="hidden" id="idArtikelKS" value="<?php echo $detail['idArtikelKS'] ?>">
                                </p>
                                <p>

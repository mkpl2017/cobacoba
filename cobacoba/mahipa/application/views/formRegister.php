...
<html class="no-js">
    ...
    <div class="container">
		<div class="row">
			<div class="col-md-4 col-md-offset-4 well">
                <h3>Sign up to MAHIPA</h3>
                <form action="<?php echo base_url();?>authentifikasi/registrasi" method="POST" class="popup-form">
                    <input type="text" name="nama" class="form-control form-white" placeholder="Name" required>
	...
	<div class="row">
		...
		Already Registered? <a href="<?php echo base_url(); ?>authentifikasi/login">Login Here</a>

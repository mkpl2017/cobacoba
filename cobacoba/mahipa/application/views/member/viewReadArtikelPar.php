...
<html class="no-js">
    <head>
        ...
        <!-- star css -->
        <link rel="stylesheet" href="<?php echo base_url();?>/asset/css/star.css">
        ...
        <script>
            function beriRating(rate){
                var idArtikel = document.getElementById('idArtikelPar').value;
                var idUser = document.getElementById('idUser').value;
                var dataString = 'idArtikelPar='+idArtikel+"&idUser="+idUser+"&star="+rate;
                $.ajax({
                    type:"get",
                    url:"<?php echo base_url();?>rating/berirating",
                    data:dataString,
                    cache:false,
        ...
        <section class="global-page-header">
            ...
            <section class="single-post">
                <div class="container">
                    ...
                    <form name="form1" method="post" class="myform">
                        <h3>Give Rating</h3>
                        <p>
                            <input name="idArtikelPar" type="hidden" id="idArtikelPar" value="<?php echo $artikel[0]->idArtikelPar ?>">
                        </p>
                        <p>
                            <input name="idUser" type="hidden" id="idUser" value="<?php echo $this->session->userdata('idUser') ?>">
                        </p>
                        <p>
                          <span class="rating">
                          <span class="star" title="5 - I love it" onclick="return beriRating(5)"></span>
                          <span class="star" title="4 - I really like it" onclick="return beriRating(4)"></span>
                          <span class="star" title="3 - I like it" onclick="return beriRating(3)"></span>
                          <span class="star" title="2 - It&#39;s ok" onclick="return beriRating(2)"></span>
                          <span class="star" title="1 - Not for me" onclick="return beriRating(1)"></span>
                        </span>
                        </p> 
                    </form>  

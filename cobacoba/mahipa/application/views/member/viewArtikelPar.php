                    ...
                    <div class="col-md-12">
                        <div class="block">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="active">Artikel Pariwisata</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-12">
                            <article class="wow fadeInDown" data-wow-delay=".3s" data-wow-duration="500ms">
                                <div class="blog-content">
                                    ...
                                    <a href="<?php echo base_url();?>artikelpar/readartikelpar/<?php echo $row->idArtikelPar; ?>"><?php echo $row->judul; ?></a>
                                    </h2>
                                         <?php echo $row->ringkasan; ?>
                                    <a href="<?php echo base_url();?>artikelpar/readartikelpar/<?php echo $row->idArtikelPar; ?>" class="btn btn-dafault btn-details">Read More</a>
